...
b.trd.tsk.current = [["o/b", "c", [], "o/b"], ["o/e.trd.tsk", "debugPrint", ["block me uwu"], "o/b"]]  # ran
e.trd.tsk.current = [["o/b", "c", [], "o/e"]]  # ran
f.trd.tsk.current = [["o/b", "c", [], "o/f"]]  # ran
d = CGE.CGESession("d", [b, e, f], ['c', False], permissions={"c": "default"})
d.start()