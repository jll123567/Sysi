...
last_id=0
index=object.data([object.data(["Hello, world!","sysh V10.0 is here. Hope you're hyped. :D",1],{'uni':'main','id':'idx1','name':'Hello, world!','terms':['sys','Hello,world!','v10.0']})],{"name":"index","uni":"main","id":"dt0","terms":["index","sys","data"]})
for i in index.d:
    if i.d[2]>last_id:
        last_id=i.d[2]
